...
DROP TRIGGER IF EXISTS trigger_update_word_count ON public.seo_content;
...
DROP POLICY IF EXISTS "Public can read published SEO content" ON public.seo_content;
DROP POLICY IF EXISTS "Service role can manage SEO content" ON public.seo_content;
