  ...
  return (
    <>
      ...
      <div className="profile-page">
        {/* Owner Banner for Unclaimed Profiles */}
        {profile && !profile.is_claimed && (
          <UnclaimedProfileBanner
            profile={profile}
            viewCount={null} // TODO: Add view count tracking when analytics are available
          />
        )}
          ...
          <div className="container">
            <div className="profile-content-grid">
              ...
              <div className="profile-sidebar-content">
                ...
                {/* Claim Profile Card - High visibility for unclaimed profiles */}
                {!profile.is_claimed && (
                  <div className="sidebar-card claim-profile-card" style={{
                    ...
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <h3 style={{
                        ...
                        Is this your profile, {profile.full_name.split(' ')[0]}?
                      </h3>
                      <p style={{
                        ...
                        Claim it for free to manage leads, update your information, and get email notifications when couples contact you.
                      </p>
                      <Link
