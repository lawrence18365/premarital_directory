        ...
        <div className="claim-wizard">
          <div className="claim-wizard__success">
            ...
            <div style={{
              ...
              <h4 style={{ color: 'var(--ds-ink)', marginBottom: '1rem' }}>
                <i className="fa fa-search" style={{ marginRight: '0.5rem' }}></i>
                Maximize Your Visibility
              </h4>
              <p style={{ color: 'var(--ds-ink-muted)', fontSize: '0.9rem', marginBottom: '1rem' }}>
                After claiming, complete these steps to rank higher in Google:
              </p>
              <ul style={{ color: 'var(--ds-ink-muted)', fontSize: '0.85rem', margin: 0, paddingLeft: '1.5rem' }}>
